...
const recordsFile = path.join(__dirname, "records_without_fog.txt");
...
function readMetrics() {
  try {
    ...
    console.error(
      "Error reading performance_metrics_without_fog.json:",
      error
    );
...
function writeMetrics(metrics) {
  try {
    ...
    console.error(
      "Error writing performance_metrics_without_fog.json:",
      error
    );
  }
}
...
// ======================================================
// HELPER: APPEND TO records_without_fog.txt
// ======================================================
...
function appendRecord(record) {
  ...
  fs.appendFile(recordsFile, log, (err) => {
    if (err) {
      console.error(
        "Error writing records_without_fog.txt:",
        err
      );
    }
  });
...
app.get("/", (req, res) => {
  res.json({
    status: "running",
    service: "Drug Supply Chain Baseline Server (Without Fog)",
...
app.post("/store", async (req, res) => {
  ...
  try {
    ...
    console.log("\n======================================");
    console.log("New baseline transaction received");
